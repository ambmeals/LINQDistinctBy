namespace LINQSamples
{
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public List<Product> TakeWhileQuery()
    {
      ...
      // Write Query Syntax Here
      list = (from product in products
                                    select product).TakeWhile(p => p.ListPrice < 100).ToList();
    ...
    public List<Product> TakeWhileMethod()
    {
     ...
     list = products.OrderBy(p => p.Name).TakeWhile(p => p.ListPrice < 100).ToList();
    ...
    public List<Product> SkipMethod()
    {
      ...
      // Write Method Syntax Here
      list = products.OrderBy(p => p.Name).Skip(5).ToList();
    ...
    public List<Product> SkipWhileQuery()
    {
      ...
      // Write Query Syntax Here
      list = (from product in products
                                 select product).SkipWhile(p => p.ListPrice < 100).ToList();
    ...
    public List<Product> SkipWhileMethod()
    {
      ...
      // Write Method Syntax Here
     list = products.OrderBy(p => p.Name).SkipWhile(p => p.ListPrice < 100).ToList();
    ...
    public List<string> DistinctWhere()
    {
      ...
      // Write Method Syntax Here
      list = products.Select(p => p.Color)
          .Distinct().OrderBy(c => c).ToList();
